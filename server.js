...
// utility function to create a design document to count the frequency of each wine type
    ...
    const designDoc = {
      views: {
        test: {
          ...
          reduce: '_count',
          // simple map function to create an index on the 'wine' attribute
          map: 'function (doc) {\n  emit(doc.wine, null);\n}'
        }
      }
    }
...
// respond to POST requests to the /wine endpoint
app.post('/wine', async (req, res) => {
  // extract the chosen wine from the POSted body
